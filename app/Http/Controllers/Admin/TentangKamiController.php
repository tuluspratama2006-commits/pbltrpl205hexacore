    ...
    public function update(Request $request)
    {
        ...
        */
        ...
        if ($request->hasFile('tentang_hero_image')) {
            ...
            $data['tentang_hero_image'] =
                $request->file('tentang_hero_image')
        ...
        */
        ...
        if ($request->hasFile('dokumen_pdf')) {
            ...
            if ($profil->dokumen_pdf) {
                Storage::disk('public')->delete($profil->dokumen_pdf);
            }

            $data['dokumen_pdf'] =
                $request->file('dokumen_pdf')
        ...
        */
        ...
        if ($request->hasFile('foto_baru')) {
            ...
            $fotoGrid = array_slice(
                array_merge($fotoBaru, $fotoGrid),
                0,
                5
            );
        }
