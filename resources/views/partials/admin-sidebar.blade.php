<div class="sidebar">
    <div class="sidebar-logo">
        <div class="logo-icon">
            <img src="{{ asset('images/logo.png') }}" alt="BAT" width="36" height="36"
        ...
        <ul>
            ...
            <li class="{{ request()->routeIs('admin.pengaturan*') ? 'active' : '' }}">
                <a href="{{ route('admin.pengaturan') }}">
                    <span class="nav-icon">
                        {{-- Pengaturan: gear/roda gigi merah muda --}}
